function startApp() {
    ...
    const kinveyAppKey = "kid_B1r3CNoZe";
    const kinveyAppSecret = "5b7d778c5b744181a2fb932bacf24270";
    ...
    function resetStats(){
        ...
        $.ajax({
            method: "GET",
            url: kinveyBaseUrl + "user/" + kinveyAppKey + "/58e22e4ab82838be2aa63e0b",
            headers: getKinveyUserAuthHeaders(),
        ...
        function loadUsersSuccess(players) {
            ...
            function loadMatchesSuccess(matches) {
                ...
                for (let match of matches) {
                    ...
                    match.team1.player1.playerstats = playersMap.get(match.team1.player1.username).playerstats;
                    match.team1.player2.playerstats = playersMap.get(match.team1.player2.username).playerstats;
                    match.team1.player3.playerstats = playersMap.get(match.team1.player3.username).playerstats;
                    match.team1.player4.playerstats = playersMap.get(match.team1.player4.username).playerstats;
                    match.team1.player5.playerstats = playersMap.get(match.team1.player5.username).playerstats;
                    match.team1.player6.playerstats = playersMap.get(match.team1.player6.username).playerstats;

                    match.team2.player1.playerstats = playersMap.get(match.team2.player1.username).playerstats;
                    match.team2.player2.playerstats = playersMap.get(match.team2.player2.username).playerstats;
                    match.team2.player3.playerstats = playersMap.get(match.team2.player3.username).playerstats;
                    match.team2.player4.playerstats = playersMap.get(match.team2.player4.username).playerstats;
                    match.team2.player5.playerstats = playersMap.get(match.team2.player5.username).playerstats;
                    match.team2.player6.playerstats = playersMap.get(match.team2.player6.username).playerstats;
                    ...
                    if (team1rank > team2rank) {
                        ...
                        if (Number(match.team1.result) > Number(match.team2.result)) {
                            winsTeamOne = 1;
                            lossesTeamTwo = 1;
                            coefficientTeamOne = 200 / (200 + rankDifference);
                            coefficientTeamTwo = (200 + rankDifference) / 200;
                            pointsTeamOne = Math.round((10 + goalDifference) * coefficientTeamOne);
                            pointsTeamTwo = Math.round((10 - goalDifference) * coefficientTeamTwo);
                            updatePlayersMap();
                        }
                        ...
                        if (Number(match.team1.result) > Number(match.team2.result)) {
                            winsTeamOne = 1;
                            lossesTeamTwo = 1;
                            coefficientTeamOne = (200 + rankDifference) / 200;
                            coefficientTeamTwo = 200 / (200 + rankDifference);
                            pointsTeamOne = Math.round((10 + goalDifference) * coefficientTeamOne);
                            pointsTeamTwo = Math.round((10 - goalDifference) * coefficientTeamTwo);
                            updatePlayersMap();
                        }
